...
class SBXCrossoverD(Crossover[FloatSolution, FloatSolution]):
    __EPS = 1.0e-14

    def __init__(self, probability: float, distribution_index: float = 20.0):
        super(SBXCrossoverD, self).__init__(probability=probability)
...
class SinglePointCrossoverD(Crossover[FloatSolution, FloatSolution]):
    __EPS = 1.0e-14

    def __init__(self, probability: float, distribution_index: float = 20.0):
        super(SinglePointCrossoverD, self).__init__(probability=probability)
        ...
        if rand <= self.probability:
            ...
            for i in range(0, parents[0].number_of_variables):
                ...
                if random.random() <= 0.25:
                    ...
                    offspring[0].variables[i] = value_x2
                    offspring[1].variables[j] = value_x1
                else:
                    offspring[0].variables[i] = value_x1
                    offspring[1].variables[j] = value_x2
        return offspring
...
class DifferentialEvolutionCrossoverD(Crossover[FloatSolution, FloatSolution]):
    ...
    def __init__(self, CR: float, F: float, K: float):
        super(DifferentialEvolutionCrossoverD, self).__init__(probability=1.0)
        self.CR = CR
        self.F = F
        self.K = K
